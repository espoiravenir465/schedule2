...
//イベント一覧
Route::get('/{schedule_id}/events', 'ScheduleController@Eventindex')->name('event.index');
//イベント詳細
Route::get('/{schedule_id}/{event_id}', 'ScheduleController@Eventdetail')->name('event.detail');